...
//    if( !capture )
    ...
    cv::namedWindow( BACKPROJ_HIST_PROC_IMAGE_WINDOW_NAME, 1 );
        std::cout << "7" <<std::endl;
    cv::moveWindow( BACKPROJ_HIST_PROC_IMAGE_WINDOW_NAME, 4*img_width, img_height);
        std::cout << "8" <<std::endl;
    ...
    while(cv_running)
    {
        ...
        iplimg = cvIplImage(*simulated_frame); //Backwards compatibility, TODO: remove
     ...
     //   frame = cvQueryFrame( capture );
        ...
        cvLine(image,cvPoint((int)desired_s_opencvf[0],0),cvPoint((int)desired_s_opencvf[0],image->height),cvScalar((10), (10), (10), 1));
        cvLine(image,cvPoint(0,(int)desired_s_opencvf[1]),cvPoint(image->width,(int)desired_s_opencvf[1]),cvScalar((10), (10), (10), 1));
